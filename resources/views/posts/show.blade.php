        ...
        <main class="max-w-6xl mx-auto mt-10 lg:mt-20 space-y-6">
            <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10 ">
                ...
                <section class="col-span-8 col-start-5 space-y-6">
                    ...
                    <form action="#" method="post" class="border border-gray-300 p-6 rounded-xl ">
                        @csrf
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="body" class="p-2 w-full text-sm focus:outline-none focus:ring" id=""  rows="5" placeholder="quick, things of something to write"></textarea>
